...
public class ImpactedDevices {
    ...
    // constructor
    ImpactedDevices(int V,int[][] edges, int brokenNode) {
    ...
    public static void main(String[] args) {
        ...
        int brokenNode = 4;
        // Create a graph
        ImpactedDevices ispApp = new ImpactedDevices(8,edges,brokenNode);

        System.out.println("Interrupted Networks:");
        //Get Disconencted Networks
        List<Integer> subgraphs = ispApp.getDisconnectedSubgraphs();
